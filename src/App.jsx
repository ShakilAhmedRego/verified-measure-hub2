      ...
      <header className="sticky top-0 z-50 bg-white/98 backdrop-blur-md border-b border-[#C4C8CE]/60">
        <nav className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-12 h-20 sm:h-24 flex items-center">
          ...
          <div className="flex-1 flex justify-center min-w-0">
            <div className="flex items-center gap-4 sm:gap-8 lg:gap-12 overflow-x-auto whitespace-nowrap [-webkit-overflow-scrolling:touch] no-scrollbar px-4">
              {tabs.map(tab => (
                <button
                  key={tab.id}
          ...
          <div className="flex-shrink-0">
            <a
              ...
              className="relative group px-4 sm:px-6 lg:px-8 py-2.5 sm:py-3.5 bg-[#1e4fc7] text-white font-semibold text-[14px] sm:text-[15px] rounded-xl overflow-hidden shadow-lg shadow-[#1e4fc7]/25 hover:shadow-xl hover:shadow-[#1e4fc7]/30 transition-all"
            >
